            ...
            for (int j = i + 1; j < coords.size(); j++) {
                ...
                if (slope < 0) {
                    if (coords[i].first < coords[j].first) {
                        ...
                        while (AN_first.first >= 0 && AN_first.second >= 0 && AN_first.first < bound && AN_first.second < bound) {
                            antinodes.insert(AN_first);
                            AN_first = {AN_first.first - offset.first, AN_first.second - offset.second};
                        ...
                        while (AN_second.first >= 0 && AN_second.second >= 0 && AN_second.first < bound && AN_second.second < bound) {
                            antinodes.insert(AN_second);
                            AN_second = {AN_second.first + offset.first, AN_second.second + offset.second};
